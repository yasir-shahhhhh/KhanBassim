...
`));
  ...
  (function() {
    for (var l in o) {
      var c = o[l];
      t[l] = e({ args: ["array", "array", "array"], body: { args: ["a", "b", "c"], body: "a=b" + c + "c" }, funcName: l }), t[l + "eq"] = e({ args: ["array", "array"], body: { args: ["a", "b"], body: "a" + c + "=b" }, funcName: l + "eq" }), t[l + "s"] = e({ args: ["array", "array", "scalar"], body: { args: ["a", "b", "s"], body: "a=b" + c + "s" }, funcName: l + "s" }), t[l + "seq"] = e({ args: ["array", "scalar"], body: { args: ["a", "s"], body: "a" + c + "=s" }, funcName: l + "seq" });
    }
  })();
  ...
  (function() {
    for (var l in r) {
      var c = r[l];
      t[l] = e({ args: ["array", "array"], body: { args: ["a", "b"], body: "a=" + c + "b" }, funcName: l }), t[l + "eq"] = e({ args: ["array"], body: { args: ["a"], body: "a=" + c + "a" }, funcName: l + "eq" });
    }
  })();
  ...
  (function() {
    for (var l in h) {
      var c = h[l];
      t[l] = e({ args: ["array", "array", "array"], body: { args: ["a", "b", "c"], body: "a=b" + c + "c" }, funcName: l }), t[l + "s"] = e({ args: ["array", "array", "scalar"], body: { args: ["a", "b", "s"], body: "a=b" + c + "s" }, funcName: l + "s" }), t[l + "eq"] = e({ args: ["array", "array"], body: { args: ["a", "b"], body: "a=a" + c + "b" }, funcName: l + "eq" }), t[l + "seq"] = e({ args: ["array", "scalar"], body: { args: ["a", "s"], body: "a=a" + c + "s" }, funcName: l + "seq" });
    }
  })();
  ...
  (function() {
    for (var l = 0; l < u.length; ++l) {
      var c = u[l];
      t[c] = e({ args: ["array", "array"], pre: { args: [], body: "this_f=Math." + c, thisVars: ["this_f"] }, body: { args: ["a", "b"], body: "a=this_f(b)", thisVars: ["this_f"] }, funcName: c }), t[c + "eq"] = e({ args: ["array"], pre: { args: [], body: "this_f=Math." + c, thisVars: ["this_f"] }, body: { args: ["a"], body: "a=this_f(a)", thisVars: ["this_f"] }, funcName: c + "eq" });
    }
  })();
